  ...
  return (
    <section className="relative bg-black py-14 px-4 overflow-hidden">
      ...
      <div className="relative text-center max-w-4xl mx-auto z-10">
        <div className="flex flex-colsm: flex-row items-center justify-center betweengap-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-5 md:p-6">
          
          {/* Left Side - Text */}
          <div className="text-center smtext-left">
            <div className="relative items-center gap-3 mb-1 justify-center sm:justifystart">
            ...
            {/* Availability Badge */}
            <div className="hidden sm:flexitems-center gap-1.5 text-xs text-gray-400 border-r border-white/10 pr-4">
            ...
            <a
              ...
              className="flex flex-row justify-center my-4 gap- group"
            >
              <span className="hidden mdinline text-white font-medium text-sm group-hover:text-green-400 transition-colors">
                +254 728 240 931
              </span>
              ...
              >
                ...
                <div className="relativ w-12 h-12 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center shadow-lg shadow-green-500/20 group-hover:shadow-green-500/40 transition-all">
          ...
          <div className="hidden flexitems-center gap-4">
            {/* Availability Badge */}
