...
export default function Hero() {
  return (
    <div className="pt-28 px-5 text-white items-center justify-center min-h-screen relative bg-cover bg-center" style={{ backgroundImage: "url('/images/1000_F_248500652_ODdXTJo565M5YO8wO7nvawB1li0uLtOZ.jpg')" }}>
    ...
    <div className="grid md:grid-cols-2 gap-8 items-center">
      ...
      <div className="space-y-5">
        <h1 className="text-5xl md:text-5xl font-extrabold leading-tight">
          Empowering Educators<span className="text-white"> To Shape </span>
